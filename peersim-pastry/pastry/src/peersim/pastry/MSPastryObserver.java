...
public class MSPastryObserver implements Control {
    ...
    public boolean execute() {
        ...
        String s = String.format("[time=%d]:[with N=%d current nodes UP] [%d messages] [%f average hops] [%d msec average transimission time] ",
        CommonState.getTime(),
        sz,
				 MSPastryProtocol.messageRoutedCount,
        hopStore.getAverage(),
